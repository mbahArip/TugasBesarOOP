...
<body onload="selectedMenu('gudangStorage')">
    <!-- Sidebar -->
    <?php
                            ...
                            <?php foreach ($dataBarang as $b) : ?>
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <?php else : ?>
                                            <button id="btn-req-barang"><i class="delete material-icons disabled"> inventory_2 </i></button>
                                        <?php endif; ?>
                                        -->
                                    </td>
                                </tr>
    ...
    <div class="modal">
        ...
        <div id="modal-requestStock" class="requestStock modal-container">
            ...
            <form action="gudangRequest" method="post" autocomplete="off">
